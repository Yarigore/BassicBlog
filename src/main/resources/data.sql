...
--VALUES (1, 'Yarigore', 'This is a post about Yarigore.', 'https://i.ibb.co/zVzRmSf/f7b6ed96bffe.png', NOW(), NOW(), 1, 1);
--
--INSERT INTO post (id, title, content, image_url, created_at, updated_at, author_id, category_id)
--VALUES (2, 'Happy XMAS', 'Have a nice XMAS', 'https://i.ibb.co/59YD570/bf3fad397db0.webp', NOW(), NOW(), 2, 2);
--
